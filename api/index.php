...
$BDD = new mysqli("localhost","root","","biblio");
...
{	case'login':
	...
	case'personsave':
		...
		$std="act";
		$tipo="Pasante";
		$BDD->query("insert into person (nom,ap,email,pwd,std,tipo) values   ('$nom','$ap','$email','$pwd','$std','$tipo') ");
...
case'librosave':
	...
	$fechp=$_POST["fechp"];
	$stdl="act";
	$BDD->query("insert into libro (codl,noml,des,fechp,stdl) values        ('$codl','$noml','$des','$fechp','$stdl')");
	$data=array("resp"=>true,"msg"=>"se guardo");
break;
